...
if((c === "\n")){
var G__35213 = escape_QMARK_;
var G__35214 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__35213;
lines = G__35214;
continue;
} else {
buf.append(c);

var G__35215 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__35216 = lines;
escape_QMARK_ = G__35215;
lines = G__35216;
continue;
...
var G__35206 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__35206) : rewrite_clj.node.string_node.call(null,G__35206));
});
...
var G__35211 = cljs.core.re_pattern(regex);
var G__35212 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__35211,G__35212) : rewrite_clj.node.token_node.call(null,G__35211,G__35212));
});
