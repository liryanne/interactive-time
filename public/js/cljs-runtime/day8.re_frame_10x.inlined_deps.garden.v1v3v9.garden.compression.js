 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__46702){
var vec__46704 = p__46702;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46704,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46704,(1),null);
return (function (s){
...
var len__4736__auto___46736 = arguments.length;
var i__4737__auto___46737 = (0);
while(true){
if((i__4737__auto___46737 < len__4736__auto___46736)){
args__4742__auto__.push((arguments[i__4737__auto___46737]));

var G__46738 = (i__4737__auto___46737 + (1));
i__4737__auto___46737 = G__46738;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__46711_SHARP_){
return (p1__46711_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__46711_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__46711_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq46712){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq46712));
}));
...
var map__46728 = temp__5733__auto__;
var map__46728__$1 = (((((!((map__46728 == null))))?(((((map__46728.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46728.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__46728):map__46728);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46728__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46728__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46728__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__46745 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__46746 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__46733 = tag;
var G__46733__$1 = (((G__46733 instanceof cljs.core.Keyword))?G__46733.fqn:null);
switch (G__46733__$1) {
case "string":
return chunk;
