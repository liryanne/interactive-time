 ...
 */
mranderson048.garden.v1v3v3.garden.compression.token_fn = (function mranderson048$garden$v1v3v3$garden$compression$token_fn(p__29797){
var vec__29800 = p__29797;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29800,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29800,(1),null);
return (function (s){
...
var len__4736__auto___29938 = arguments.length;
var i__4737__auto___29939 = (0);
while(true){
if((i__4737__auto___29939 < len__4736__auto___29938)){
args__4742__auto__.push((arguments[i__4737__auto___29939]));

var G__29942 = (i__4737__auto___29939 + (1));
i__4737__auto___29939 = G__29942;
continue;
} else {
}
break;
...
return mranderson048.garden.v1v3v3.garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__4743__auto__);
});
...
return (function (s){
return cljs.core.some((function (p1__29804_SHARP_){
return (p1__29804_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__29804_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__29804_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(mranderson048.garden.v1v3v3.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq29805){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq29805));
}));
...
var s2 = "";
while(true){
var temp__5733__auto__ = mranderson048.garden.v1v3v3.garden.compression.stylesheet_tokenizer(s1);
if(cljs.core.truth_(temp__5733__auto__)){
var map__29832 = temp__5733__auto__;
var map__29832__$1 = (((((!((map__29832 == null))))?(((((map__29832.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29832.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29832):map__29832);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29832__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29832__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29832__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__29964 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__29965 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__29843 = tag;
