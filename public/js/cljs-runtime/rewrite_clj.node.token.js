...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k34941,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k34941,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__34953){
var vec__34954 = p__34953;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34954,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34954,(1),null);
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__34940){
var self__ = this;
var G__34940__$1 = this;
return (new cljs.core.RecordIter((0),G__34940__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"string-value","string-value",1109600561)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this34942,other34943){
var self__ = this;
var this34942__$1 = this;
return (((!((other34943 == null)))) && ((this34942__$1.constructor === other34943.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34942__$1.value,other34943.value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34942__$1.string_value,other34943.string_value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34942__$1.__extmap,other34943.__extmap)));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__34940){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__34979 = cljs.core.keyword_identical_QMARK_;
var expr__34980 = k__4388__auto__;
if(cljs.core.truth_((pred__34979.cljs$core$IFn$_invoke$arity$2 ? pred__34979.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__34980) : pred__34979.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__34980)))){
return (new rewrite_clj.node.token.TokenNode(G__34940,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__34979.cljs$core$IFn$_invoke$arity$2 ? pred__34979.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__34980) : pred__34979.call(null,new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__34980)))){
return (new rewrite_clj.node.token.TokenNode(self__.value,G__34940,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__34940),null));
}
}
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__34940){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__34940,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__34944){
var extmap__4419__auto__ = (function (){var G__34985 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__34944,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561)], 0));
...
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__34944),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__34944),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
