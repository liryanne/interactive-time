...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27800){
var G__27802 = cljs.core.first(seq27800);
var seq27800__$1 = cljs.core.next(seq27800);
var G__27803 = cljs.core.first(seq27800__$1);
var seq27800__$2 = cljs.core.next(seq27800__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27802,G__27803,seq27800__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27839_SHARP_){
return (!((cljs.core.meta(p1__27839_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27853__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27864){var _e__26679__auto__ = e27864;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e27866){var _e__26679__auto__ = e27866;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27870 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27871 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27871);

try{var map__27872 = opts;
var map__27872__$1 = (((((!((map__27872 == null))))?(((((map__27872.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27872.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27872):map__27872);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27872__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27870);
}});
...
var temp__5733__auto___27936 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___27936)){
var managed_print_level_27937 = temp__5733__auto___27936;
var _STAR_print_level_STAR__orig_val__27876_27938 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27877_27939 = managed_print_level_27937;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27877_27939);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27874_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27874_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27876_27938);
}} else {
job_fn();
}
