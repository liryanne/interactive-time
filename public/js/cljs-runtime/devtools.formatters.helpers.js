...
var G__27786 = devtools.prefs.pref(v);
v = G__27786;
continue;
} else {
return v;
...
}catch (e27756){var _e__26679__auto__ = e27756;
return false;
}})();
...
}catch (e27760){var _e__26679__auto__ = e27760;
return false;
}})();
...
}catch (e27762){var _e__26679__auto__ = e27762;
return false;
}}
}
});
...
var vec__27773 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27773,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27773,(1),null);
...
return cljs.core.some((function (p1__27776_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27776_SHARP_);
}),template);
});
