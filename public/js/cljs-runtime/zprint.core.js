...
var vec__37766 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__37769 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37769,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37769,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37766,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37766,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__37779){
var vec__37780 = p__37779;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37780,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37780,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37784,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37784,(1),null);
...
var vec__37795 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37795,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37795,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37795,(2),null);
var vec__37798 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37798,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37798,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37798,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__37815){
var vec__37816 = p__37815;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37816,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37816,(1),null);
...
var len__4736__auto___38000 = arguments.length;
var i__4737__auto___38001 = (0);
while(true){
if((i__4737__auto___38001 < len__4736__auto___38000)){
args__4742__auto__.push((arguments[i__4737__auto___38001]));

var G__38002 = (i__4737__auto___38001 + (1));
i__4737__auto___38001 = G__38002;
continue;
} else {
}
break;
...
return zprint.core.czprint_str_internal.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4743__auto__);
});

(zprint.core.czprint_str_internal.cljs$core$IFn$_invoke$arity$variadic = (function (internal_options,coll,rest){
var vec__37829 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37829,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37829,(1),null);
...
var G__37836 = zprint.core.parse_string_all_options(rest_options);
var G__37837 = zprint.core.czprint_str_internal;
var G__37838 = ":parse-string-all? call";
var G__37839 = (function (){var G__37840 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__37840) : zprint.zutil.edn_STAR_.call(null,G__37840));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__37836,G__37837,G__37838,G__37839) : zprint.core.process_multiple_forms.call(null,G__37836,G__37837,G__37838,G__37839));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__37844 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37844,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37844,(1),null);
...
/** @this {Function} */
(zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq37821){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37822,G__37823,seq37821__$2);
}));
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq37857){
var G__37858 = cljs.core.first(seq37857);
var seq37857__$1 = cljs.core.next(seq37857);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37858,seq37857__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq37864){
var G__37865 = cljs.core.first(seq37864);
var seq37864__$1 = cljs.core.next(seq37864);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37865,seq37864__$1);
}));
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq37870){
var G__37871 = cljs.core.first(seq37870);
var seq37870__$1 = cljs.core.next(seq37870);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37871,seq37870__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___38047 = arguments.length;
var i__4737__auto___38048 = (0);
while(true){
if((i__4737__auto___38048 < len__4736__auto___38047)){
args__4742__auto__.push((arguments[i__4737__auto___38048]));

var G__38049 = (i__4737__auto___38048 + (1));
i__4737__auto___38048 = G__38049;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq37876){
var G__37877 = cljs.core.first(seq37876);
var seq37876__$1 = cljs.core.next(seq37876);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37877,seq37876__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__37894,form){
var vec__37896 = p__37894;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37896,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37896,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37896,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37896,(3),null);
...
var vec__37899 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37899,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37899,(1),null);
...
var output_str = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"off","off",606440789),new cljs.core.Keyword(null,"format","format",-1306924766).cljs$core$IFn$_invoke$arity$1(decision_options))) || (((cljs.core.not((function (){var or__4126__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [((local_QMARK_)?zprint.config.merge_deep.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([next_options__$1,new_options], 0)):(cljs.core.truth_((function (){var or__4126__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return whitespace_form_QMARK_;
...
var forms = (function (){var G__37953 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__37953) : zprint.zutil.edn_STAR_.call(null,G__37953));
})();
