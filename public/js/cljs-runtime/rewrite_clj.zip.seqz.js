...
var G__35721 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__35721__$1 = (((G__35721 == null))?null:cljs.core.iterate((function (loc){
...
var G__35721__$2 = (((G__35721__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__35721__$1));
var G__35721__$3 = (((G__35721__$2 == null))?null:cljs.core.last(G__35721__$2));
if((G__35721__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__35721__$3);
}
} else {
return zloc;
}
...
var G__35735 = rewrite_clj.zip.move.right(v);
var G__35736 = rewrite_clj.zip.move.up(v);
loc = G__35735;
parent = G__35736;
continue;
} else {
var G__35737 = rewrite_clj.zip.move.right(v0);
var G__35738 = parent;
loc = G__35737;
parent = G__35738;
continue;
...
var G__35739 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__35740 = rewrite_clj.zip.move.up(v);
loc = G__35739;
parent = G__35740;
continue;
} else {
var G__35741 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__35742 = parent;
loc = G__35741;
parent = G__35742;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__35730 = zloc;
var G__35730__$1 = (((G__35730 == null))?null:rewrite_clj.zip.move.down(G__35730));
var G__35730__$2 = (((G__35730__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__35730__$1,k));
if((G__35730__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__35730__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__35734 = rewrite_clj.zip.move.down(zloc);
var G__35734__$1 = (((G__35734 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__35734));
if((G__35734__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__35734__$1);
}
})(),k);
}
});
