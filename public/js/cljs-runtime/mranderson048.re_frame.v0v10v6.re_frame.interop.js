...
return [(function (){var pred__33094 = cljs.core.instance_QMARK_;
var expr__33095 = reactive_val;
if(cljs.core.truth_((pred__33094.cljs$core$IFn$_invoke$arity$2 ? pred__33094.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__33095) : pred__33094.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__33095)))){
return "ra";
} else {
if(cljs.core.truth_((pred__33094.cljs$core$IFn$_invoke$arity$2 ? pred__33094.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__33095) : pred__33094.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__33095)))){
return "rc";
} else {
if(cljs.core.truth_((pred__33094.cljs$core$IFn$_invoke$arity$2 ? pred__33094.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__33095) : pred__33094.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__33095)))){
return "rx";
} else {
if(cljs.core.truth_((pred__33094.cljs$core$IFn$_invoke$arity$2 ? pred__33094.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__33095) : pred__33094.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__33095)))){
return "tr";
} else {
return "other";
}
