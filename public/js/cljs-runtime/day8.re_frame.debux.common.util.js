...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__62728){
...
return clojure.zip.zipper((function (p1__62732_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__62732_SHARP_)) || (cljs.core.map_QMARK_(p1__62732_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__62735){
var vec__62736 = p__62735;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62736,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62736,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__62744_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__62744_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62743_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__62743_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__62745_SHARP_){
return (((p1__62745_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__62745_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__62753,mapping){
var map__62754 = p__62753;
...
var state = map__62754__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62754__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62754__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62754__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__62752_SHARP_){
if((p1__62752_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__62752_SHARP_);
} else {
return false;
}
}),day8.re_frame.debux.common.util.form_tree_seq(form)));
...
var G__62823 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__62825 = clojure.zip.next(loc);
loc = G__62825;
continue;
}
}
...
var len__4736__auto___62837 = arguments.length;
var i__4737__auto___62838 = (0);
while(true){
if((i__4737__auto___62838 < len__4736__auto___62837)){
args__4742__auto__.push((arguments[i__4737__auto___62838]));

var G__62839 = (i__4737__auto___62838 + (1));
i__4737__auto___62838 = G__62839;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__62775){
var vec__62776 = p__62775;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62776,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq62764){
var G__62765 = cljs.core.first(seq62764);
var seq62764__$1 = cljs.core.next(seq62764);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62765,seq62764__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__62780_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__62780_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__62782_62841 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__62783_62842 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__62784_62843 = true;
var _STAR_print_fn_STAR__temp_val__62785_62844 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__62784_62843);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__62785_62844);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__62783_62842);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__62782_62841);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__62781_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__62781_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__62848 = cljs.core.next(opts__$1);
var G__62849 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__62848;
acc = G__62849;
continue;
} else {
if(typeof f === 'string'){
var G__62850 = cljs.core.next(opts__$1);
var G__62851 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__62850;
acc = G__62851;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__62852 = cljs.core.nnext(opts__$1);
var G__62853 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__62852;
acc = G__62853;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__62854 = cljs.core.next(opts__$1);
var G__62855 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__62854;
acc = G__62855;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__62789 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__62789.cljs$core$IFn$_invoke$arity$1 ? fexpr__62789.cljs$core$IFn$_invoke$arity$1(f) : fexpr__62789.call(null,f));
})())){
var G__62856 = cljs.core.next(opts__$1);
var G__62857 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__62856;
acc = G__62857;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__62790 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__62790.cljs$core$IFn$_invoke$arity$1 ? fexpr__62790.cljs$core$IFn$_invoke$arity$1(f) : fexpr__62790.call(null,f));
})())){
var G__62862 = cljs.core.nnext(opts__$1);
var G__62863 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__62862;
acc = G__62863;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__62864 = cljs.core.next(opts__$1);
var G__62865 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__62864;
acc = G__62865;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__62792){
var vec__62794 = p__62792;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62794,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62794,(1),null);
...
var G__62798 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__62797 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__62797.cljs$core$IFn$_invoke$arity$1 ? fexpr__62797.cljs$core$IFn$_invoke$arity$1(G__62798) : fexpr__62797.call(null,G__62798));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__62800 = quoted_form;
var G__62801 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__62800,G__62801) : day8.re_frame.debux.common.util.remove_d.call(null,G__62800,G__62801));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__62803 = quoted_form;
var G__62804 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__62803,G__62804) : day8.re_frame.debux.common.util.remove_d.call(null,G__62803,G__62804));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__62885__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__62809 = quoted_form;
var G__62810 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__62809,G__62810) : day8.re_frame.debux.common.util.remove_d.call(null,G__62809,G__62810));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__62885 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__62886__i = 0, G__62886__a = new Array(arguments.length -  0);
while (G__62886__i < G__62886__a.length) {G__62886__a[G__62886__i] = arguments[G__62886__i + 0]; ++G__62886__i;}
  arg = new cljs.core.IndexedSeq(G__62886__a,0,null);
} 
return G__62885__delegate.call(this,arg);};
G__62885.cljs$lang$maxFixedArity = 0;
G__62885.cljs$lang$applyTo = (function (arglist__62887){
var arg = cljs.core.seq(arglist__62887);
return G__62885__delegate(arg);
});
G__62885.cljs$core$IFn$_invoke$arity$variadic = G__62885__delegate;
return G__62885;
})()
;
});
...
var G__62888 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__62888;
continue;
} else {
...
var G__62889 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__62889;
continue;
} else {
var G__62890 = clojure.zip.next(loc);
loc = G__62890;
continue;
