...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k34950,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k34950,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__34966){
var vec__34967 = p__34966;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34967,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34967,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this34951,other34952){
var self__ = this;
var this34951__$1 = this;
return (((!((other34952 == null)))) && ((this34951__$1.constructor === other34952.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34951__$1.tag,other34952.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34951__$1.wrap_fn,other34952.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34951__$1.wrap_length,other34952.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34951__$1.seq_fn,other34952.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34951__$1.children,other34952.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this34951__$1.__extmap,other34952.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__34991 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__34991) : self__.seq_fn.call(null,G__34991));
}));
...
var self__ = this;
var this$__$1 = this;
var G__34992 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__34992) : self__.wrap_fn.call(null,G__34992));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__34949){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__35001 = cljs.core.keyword_identical_QMARK_;
var expr__35002 = k__4388__auto__;
if(cljs.core.truth_((pred__35001.cljs$core$IFn$_invoke$arity$2 ? pred__35001.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__35002) : pred__35001.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__35002)))){
return (new rewrite_clj.node.seq.SeqNode(G__34949,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__35001.cljs$core$IFn$_invoke$arity$2 ? pred__35001.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__35002) : pred__35001.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__35002)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__34949,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__35001.cljs$core$IFn$_invoke$arity$2 ? pred__35001.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__35002) : pred__35001.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__35002)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__34949,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__35001.cljs$core$IFn$_invoke$arity$2 ? pred__35001.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__35002) : pred__35001.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__35002)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__34949,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__35001.cljs$core$IFn$_invoke$arity$2 ? pred__35001.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__35002) : pred__35001.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__35002)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__34949,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__34949),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__34949){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__34949,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__34957){
var extmap__4419__auto__ = (function (){var G__35018 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__34957,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__34957)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__35018);
} else {
return G__35018;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__34957),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__34957),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__34957),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__34957),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__34957),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__35020_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__35020_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__35024_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__35024_SHARP_);
}),children);
});
