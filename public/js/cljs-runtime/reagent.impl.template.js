...
var G__37225 = o;
(G__37225[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__37353__delegate = function (args){
...
while (G__37354__i < G__37354__a.length) {G__37354__a[G__37354__i] = arguments[G__37354__i + 0]; ++G__37354__i;}
  args = new cljs.core.IndexedSeq(G__37354__a,0,null);
} 
return G__37353__delegate.call(this,args);};
G__37353.cljs$lang$maxFixedArity = 0;
G__37353.cljs$lang$applyTo = (function (arglist__37355){
var args = cljs.core.seq(arglist__37355);
return G__37353__delegate(args);
});
...
var G__37233 = o;
(G__37233[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var args = cljs.core.seq(arglist__37366);
...
var G__37238 = props;
var G__37238__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37238,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37238);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37238__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37239){
...
var props = map__37240__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37240__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37247){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37248__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__37258 = jsprops;
(G__37258["defaultValue"] = value);

(G__37258["onChange"] = (function (p1__37252_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37252_SHARP_);
}));
...
var vec__37275 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37275,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37275,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37275,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___37398 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37398 == null)){
} else {
var key_37399 = temp__5739__auto___37398;
(jsprops["key"] = key_37399);
}
...
var temp__5739__auto___37403 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___37403 == null)){
} else {
var key_37405 = temp__5739__auto___37403;
reagent.impl.template.oset(jsprops,"key",key_37405);
}
...
var G__37288 = reagent.impl.template.__GT_NativeWrapper();
(G__37288["name"] = c);
...
var G__37289 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37289) : reagent.impl.template.as_element.call(null,G__37289));
} else {
...
args__4742__auto__.push((arguments[i__4737__auto___37417]));

var G__37424 = (i__4737__auto___37417 + (1));
i__4737__auto___37417 = G__37424;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37293){
var G__37294 = cljs.core.first(seq37293);
var seq37293__$1 = cljs.core.next(seq37293);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37294,seq37293__$1);
}));
...
break;
default:
var G__37437 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37437;
continue;
...
var n__4613__auto___37438 = a.length;
var i_37439 = (0);
while(true){
if((i_37439 < n__4613__auto___37438)){
(a[i_37439] = reagent.impl.template.as_element((a[i_37439])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4613__auto___37441 = a.length;
var i_37442 = (0);
while(true){
if((i_37442 < n__4613__auto___37441)){
var val_37446 = (a[i_37442]);
if(((cljs.core.vector_QMARK_(val_37446)) && ((reagent.impl.template.key_from_vec(val_37446) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37442] = reagent.impl.template.as_element(val_37446));

var G__37447 = (i_37442 + (1));
i_37442 = G__37447;
continue;
} else {
}
...
var ctx = ({});
var vec__37321 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37321,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37321,(1),null);
...
var G__37335 = (cljs.core.count(argv) - first_child);
switch (G__37335) {
case (0):
