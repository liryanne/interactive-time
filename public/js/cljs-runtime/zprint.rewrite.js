...
var G__51267 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__51267;
continue;
} else {
var G__51268 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__51268;
continue;
}
} else {
var G__51269 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__51269;
continue;
}
}
...
var G__51215 = zloc;
var G__51216 = (function (){var G__51217 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__51218 = zloc;
var G__51218__$1 = (((G__51218 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__51218) : rewrite_clj.zip.node.call(null,G__51218)));
if((G__51218__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__51218__$1) : zprint.zutil.edn_STAR_.call(null,G__51218__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__51217) : rewrite_clj.zip.root.call(null,G__51217));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__51215,G__51216) : rewrite_clj.zip.replace.call(null,G__51215,G__51216));
});
/**
...
var G__51278 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__51278;
continue;
}
break;
...
var G__51281 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__51282 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__51281;
out = G__51282;
continue;
} else {
...
var G__51287 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__51288 = cljs.core.next(new_loc);
var G__51289 = replaced_loc;
nloc = G__51287;
new_loc = G__51288;
last_loc = G__51289;
continue;
...
return zprint.rewrite.sort_val((function (){var G__51259 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__51259) : rewrite_clj.zip.down.call(null,G__51259));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__51260_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__51260_SHARP_) : rewrite_clj.zip.tag.call(null,p1__51260_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__51260_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__51260_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
