...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__35790_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__35790_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__35790_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__35791){
var vec__35792 = p__35791;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35792,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35792,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__35796,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35797__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35797__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35797__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__35803 = (function (){var or__4126__auto__ = color;
...
var fexpr__35802 = (function (){var G__35804 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__35804) : style_map.call(null,G__35804));
})();
return (fexpr__35802.cljs$core$IFn$_invoke$arity$1 ? fexpr__35802.cljs$core$IFn$_invoke$arity$1(G__35803) : fexpr__35802.call(null,G__35803));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__35808){
var vec__35809 = p__35808;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35809,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35809,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35809,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__35812){
var vec__35813 = p__35812;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35813,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35813,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35813,(2),null);
...
var G__36182 = cljs.core.next(ssv);
var G__36183 = (this_ssv == null);
var G__36184 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__36185 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__36182;
doing_nil_QMARK_ = G__36183;
last_elide = G__36184;
out = G__36185;
continue;
}
...
var vec__35859 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35859,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35859,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35859,(2),null);
...
var G__36190 = cljs.core.next(remaining_cvec);
var G__36191 = new_idx;
var G__36192 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__36190;
idx = G__36191;
out = G__36192;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__35947,cursor_vec){
var vec__35948 = p__35947;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35948,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35948,(1),null);
var focus_vec = vec__35948;
...
var vec__35951 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35951,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35951,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__35958){
var vec__35959 = p__35958;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35959,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35959,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__35968,existing_count){
var vec__35969 = p__35968;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35969,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35969,(1),null);
...
return cljs.core.filterv((function (p1__35963_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__35963_SHARP_))));
...
var vec__35996 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35996,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35996,(1),null);
var cvec_element = vec__35996;
if((cvec_element == null)){
var G__36216 = cljs.core.next(cvec_nl);
var G__36217 = (idx + (1));
var G__36218 = start;
var G__36219 = out;
cvec_nl = G__36216;
...
var G__36225 = cljs.core.next(cvec_nl);
var G__36226 = (idx + (1));
var G__36227 = idx;
var G__36228 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__36225;
idx = G__36226;
start = G__36227;
out = G__36228;
...
var G__36229 = cljs.core.next(cvec_nl);
var G__36230 = (idx + (1));
var G__36231 = (idx + (1));
var G__36232 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__36229;
idx = G__36230;
start = G__36231;
out = G__36232;
...
var G__36233 = cljs.core.next(cvec_nl);
var G__36234 = (idx + (1));
var G__36235 = idx;
var G__36236 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__36233;
idx = G__36234;
start = G__36235;
out = G__36236;
...
var G__36239 = cljs.core.next(cvec_nl);
var G__36240 = (idx + (1));
var G__36241 = start;
var G__36242 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__36239;
idx = G__36240;
start = G__36241;
out = G__36242;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__36010_SHARP_,p2__36009_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__36009_SHARP_)){
return cljs.core.reduced(p1__36010_SHARP_);
} else {
return (p1__36010_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__36017,p__36018){
var vec__36019 = p__36017;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36019,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36019,(1),null);
var vec__36022 = p__36018;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36022,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36022,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__36041,cvec,focus_vec){
...
var options = map__36042__$1;
var map__36043 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36042__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36043__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36043__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36043__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36038_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__36038_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
