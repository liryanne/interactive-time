...
var o27493 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27493["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27494 = temp__5733__auto____$1;
return (o27494["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26658__auto__ = f;
return (o__26658__auto__["toString"]).call(o__26658__auto__);
} else {
return "";
}
}catch (e27495){var _ = e27495;
return "";
}});
...
try{var o__26658__auto___27747 = t;
(o__26658__auto___27747["cljs$lang$ctorPrWriter"]).call(o__26658__auto___27747,t,writer);
}catch (e27496){var __27748 = e27496;
}
...
var char_code = (function (){var o__26658__auto__ = (new String(char$));
return (o__26658__auto__["charCodeAt"]).call(o__26658__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26658__auto__ = String;
return (o__26658__auto__["fromCharCode"]).call(o__26658__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27504 = num_code;
switch (G__27504) {
case (1):
return (185);
...
var o__26658__auto__ = String;
return (o__26658__auto__["fromCharCode"]).call(o__26658__auto__,superscript_code);
});
/**
...
}catch (e27511){var _e__26679__auto__ = e27511;
return false;
}})())){
...
var vec__27513 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27513,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o27525 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27525["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27526 = temp__5733__auto____$1;
return (o27526["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27554){
var vec__27557 = p__27554;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27557,(0),null);
...
var G__27767 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27768 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27767;
remaining_tokens = G__27768;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27527){
var G__27530 = cljs.core.first(seq27527);
var seq27527__$1 = cljs.core.next(seq27527);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27530,seq27527__$1);
}));
...
var vec__27576 = cljs.core.split_with((function (p1__27574_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27574_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27576,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27576,(1),null);
...
var vec__27590 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27590,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27590,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27770 = cljs.core.rest(remaining_tokens);
var G__27771 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27770;
name_tokens = G__27771;
continue;
} else {
...
var vec__27598 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27598,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27598,(1),null);
var vec__27601 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27601,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27601,(1),null);
var vec__27604 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27604,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27604,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27604,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27604,(3),null);
...
var vec__27614 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27614,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27614,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27614,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27614,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27614,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27614,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__27617 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27617,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27617,(1),null);
var vec__27620 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27620,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27620,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27623 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27623) : devtools.munging.parse_fn_info_deep.call(null,G__27623));
})()));
}
} else {
return fn_info;
...
var G__27793 = (arity + (1));
var G__27794 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27638){
var vec__27639 = p__27638;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27639,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27639,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27645_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27645_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27646_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27646_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___27798 = arguments.length;
var i__4737__auto___27799 = (0);
while(true){
if((i__4737__auto___27799 < len__4736__auto___27798)){
args__4742__auto__.push((arguments[i__4737__auto___27799]));

var G__27801 = (i__4737__auto___27799 + (1));
i__4737__auto___27799 = G__27801;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27654){
var vec__27656 = p__27654;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27656,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27648){
var G__27649 = cljs.core.first(seq27648);
var seq27648__$1 = cljs.core.next(seq27648);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27649,seq27648__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27682__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27682__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27682__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27682__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27683 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27683,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27683,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27683,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27683,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27683,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27683,(5),null);
...
var o__26658__auto__ = f;
return (o__26658__auto__["getBasis"]).call(o__26658__auto__);
});
/**
...
}catch (e27695){var _e__26679__auto__ = e27695;
...
var G__27837 = (obj[cljs.core.first(path)]);
var G__27838 = cljs.core.rest(path);
obj = G__27837;
path = G__27838;
continue;
} else {
...
var _STAR_ = (function (accum,p__27708){
var vec__27709 = p__27708;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27709,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27709,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27729){
var vec__27730 = p__27729;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27730,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27730,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27730,(2),null);
...
var post_process = (function (p__27741){
var vec__27742 = p__27741;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27742,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27742,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27737_SHARP_){
return (obj[cljs.core.first(p1__27737_SHARP_)]);
}),sorted_matches);
