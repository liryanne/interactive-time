...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k46327,else__4383__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__46342){
var vec__46343 = p__46342;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46343,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46343,(1),null);
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46326){
var self__ = this;
var G__46326__$1 = this;
return (new cljs.core.RecordIter((0),G__46326__$1,7,new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"red","red",-969428204),new cljs.core.Keyword(null,"green","green",-945526839),new cljs.core.Keyword(null,"blue","blue",-622100620),new cljs.core.Keyword(null,"hue","hue",-508078848),new cljs.core.Keyword(null,"saturation","saturation",-14247929),new cljs.core.Keyword(null,"lightness","lightness",-2040901930),new cljs.core.Keyword(null,"alpha","alpha",-1574982441)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46328,other46329){
var self__ = this;
var this46328__$1 = this;
return (((!((other46329 == null)))) && ((this46328__$1.constructor === other46329.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46328__$1.red,other46329.red)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46328__$1.green,other46329.green)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46328__$1.blue,other46329.blue)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46328__$1.hue,other46329.hue)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46328__$1.saturation,other46329.saturation)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46328__$1.lightness,other46329.lightness)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46328__$1.alpha,other46329.alpha)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46328__$1.__extmap,other46329.__extmap)));
}));
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__46326){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__46380 = cljs.core.keyword_identical_QMARK_;
var expr__46381 = k__4388__auto__;
if(cljs.core.truth_((pred__46380.cljs$core$IFn$_invoke$arity$2 ? pred__46380.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"red","red",-969428204),expr__46381) : pred__46380.call(null,new cljs.core.Keyword(null,"red","red",-969428204),expr__46381)))){
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor(G__46326,self__.green,self__.blue,self__.hue,self__.saturation,self__.lightness,self__.alpha,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46380.cljs$core$IFn$_invoke$arity$2 ? pred__46380.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"green","green",-945526839),expr__46381) : pred__46380.call(null,new cljs.core.Keyword(null,"green","green",-945526839),expr__46381)))){
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor(self__.red,G__46326,self__.blue,self__.hue,self__.saturation,self__.lightness,self__.alpha,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46380.cljs$core$IFn$_invoke$arity$2 ? pred__46380.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"blue","blue",-622100620),expr__46381) : pred__46380.call(null,new cljs.core.Keyword(null,"blue","blue",-622100620),expr__46381)))){
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor(self__.red,self__.green,G__46326,self__.hue,self__.saturation,self__.lightness,self__.alpha,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46380.cljs$core$IFn$_invoke$arity$2 ? pred__46380.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"hue","hue",-508078848),expr__46381) : pred__46380.call(null,new cljs.core.Keyword(null,"hue","hue",-508078848),expr__46381)))){
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor(self__.red,self__.green,self__.blue,G__46326,self__.saturation,self__.lightness,self__.alpha,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46380.cljs$core$IFn$_invoke$arity$2 ? pred__46380.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"saturation","saturation",-14247929),expr__46381) : pred__46380.call(null,new cljs.core.Keyword(null,"saturation","saturation",-14247929),expr__46381)))){
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor(self__.red,self__.green,self__.blue,self__.hue,G__46326,self__.lightness,self__.alpha,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46380.cljs$core$IFn$_invoke$arity$2 ? pred__46380.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"lightness","lightness",-2040901930),expr__46381) : pred__46380.call(null,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),expr__46381)))){
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor(self__.red,self__.green,self__.blue,self__.hue,self__.saturation,G__46326,self__.alpha,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46380.cljs$core$IFn$_invoke$arity$2 ? pred__46380.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"alpha","alpha",-1574982441),expr__46381) : pred__46380.call(null,new cljs.core.Keyword(null,"alpha","alpha",-1574982441),expr__46381)))){
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor(self__.red,self__.green,self__.blue,self__.hue,self__.saturation,self__.lightness,G__46326,self__.__meta,self__.__extmap,null));
} else {
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor(self__.red,self__.green,self__.blue,self__.hue,self__.saturation,self__.lightness,self__.alpha,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__46326),null));
}
}
}
}
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__46326){
var self__ = this;
var this__4379__auto____$1 = this;
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor(self__.red,self__.green,self__.blue,self__.hue,self__.saturation,self__.lightness,self__.alpha,G__46326,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__46395 = (arguments.length - (1));
switch (G__46395) {
case (0):
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor.prototype.apply = (function (self__,args46333){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args46333)));
}));
 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.map__GT_CSSColor = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$map__GT_CSSColor(G__46330){
var extmap__4419__auto__ = (function (){var G__46408 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46330,new cljs.core.Keyword(null,"red","red",-969428204),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"green","green",-945526839),new cljs.core.Keyword(null,"blue","blue",-622100620),new cljs.core.Keyword(null,"hue","hue",-508078848),new cljs.core.Keyword(null,"saturation","saturation",-14247929),new cljs.core.Keyword(null,"lightness","lightness",-2040901930),new cljs.core.Keyword(null,"alpha","alpha",-1574982441)], 0));
if(cljs.core.record_QMARK_(G__46330)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46408);
} else {
return G__46408;
}
})();
return (new day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.CSSColor(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(G__46330),new cljs.core.Keyword(null,"green","green",-945526839).cljs$core$IFn$_invoke$arity$1(G__46330),new cljs.core.Keyword(null,"blue","blue",-622100620).cljs$core$IFn$_invoke$arity$1(G__46330),new cljs.core.Keyword(null,"hue","hue",-508078848).cljs$core$IFn$_invoke$arity$1(G__46330),new cljs.core.Keyword(null,"saturation","saturation",-14247929).cljs$core$IFn$_invoke$arity$1(G__46330),new cljs.core.Keyword(null,"lightness","lightness",-2040901930).cljs$core$IFn$_invoke$arity$1(G__46330),new cljs.core.Keyword(null,"alpha","alpha",-1574982441).cljs$core$IFn$_invoke$arity$1(G__46330),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.rgb.cljs$core$IFn$_invoke$arity$1 = (function (p__46421){
var vec__46422 = p__46421;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46422,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46422,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46422,(2),null);
var vs = vec__46422;
if(cljs.core.every_QMARK_((function (p1__46409_SHARP_){
return day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.util.between_QMARK_(p1__46409_SHARP_,(0),(255));
}),vs)){
var G__46425 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"red","red",-969428204),r,new cljs.core.Keyword(null,"green","green",-945526839),g,new cljs.core.Keyword(null,"blue","blue",-622100620),b], null);
return (day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__46425) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.call(null,G__46425));
} else {
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.rgba.cljs$core$IFn$_invoke$arity$1 = (function (p__46431){
var vec__46432 = p__46431;
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46432,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46432,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46432,(2),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46432,(3),null);
if(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.util.between_QMARK_(a,(0),(1))){
var G__46436 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.rgb.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [r,g,b], null)),new cljs.core.Keyword(null,"alpha","alpha",-1574982441),a);
return (day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__46436) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.call(null,G__46436));
} else {
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hsl.cljs$core$IFn$_invoke$arity$1 = (function (p__46442){
var vec__46443 = p__46442;
var h = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46443,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46443,(1),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46443,(2),null);
var vec__46446 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46437_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(p1__46437_SHARP_,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),p1__46437_SHARP_);
}),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [h,s,l], null));
var h__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46446,(0),null);
var s__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46446,(1),null);
var l__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46446,(2),null);
...
var G__46457 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"hue","hue",-508078848),cljs.core.mod(h__$1,(360)),new cljs.core.Keyword(null,"saturation","saturation",-14247929),s__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),l__$1], null);
return (day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__46457) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.call(null,G__46457));
} else {
...
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hsla.cljs$core$IFn$_invoke$arity$1 = (function (p__46464){
var vec__46466 = p__46464;
var h = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46466,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46466,(1),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46466,(2),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46466,(3),null);
if(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.util.between_QMARK_(a,(0),(1))){
var G__46471 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hsl.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [h,s,l], null)),new cljs.core.Keyword(null,"alpha","alpha",-1574982441),a);
return (day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__46471) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.call(null,G__46471));
} else {
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Alpha value must be between 0 and 1",cljs.core.PersistentArrayMap.EMPTY);
}
}));
...
var vec__46487 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46487,(0),null);
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46487,(1),null);
var hex__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((3),cljs.core.count(hex)))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__46484_SHARP_){
return (new cljs.core.List(null,p1__46484_SHARP_,(new cljs.core.List(null,p1__46484_SHARP_,null,(1),null)),(2),null));
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([hex], 0))):hex);
return day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.rgb.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46485_SHARP_){
return day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.util.string__GT_int.cljs$core$IFn$_invoke$arity$variadic(p1__46485_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(16)], 0));
 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.rgb__GT_hex = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$rgb__GT_hex(p__46495){
var map__46497 = p__46495;
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46497__$1,new cljs.core.Keyword(null,"red","red",-969428204));
var g = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46497__$1,new cljs.core.Keyword(null,"green","green",-945526839));
var b = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46497__$1,new cljs.core.Keyword(null,"blue","blue",-622100620));
 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.rgb__GT_hsl = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$rgb__GT_hsl(p__46511){
...
var color = map__46512__$1;
var red = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46512__$1,new cljs.core.Keyword(null,"red","red",-969428204));
var green = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46512__$1,new cljs.core.Keyword(null,"green","green",-945526839));
var blue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46512__$1,new cljs.core.Keyword(null,"blue","blue",-622100620));
if(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hsl_QMARK_(color)){
return color;
} else {
var vec__46519 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46510_SHARP_){
return (p1__46510_SHARP_ / (255));
}),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [red,green,blue], null));
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46519,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46519,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46519,(2),null);
...
var d = (mx - mn);
var h = (function (){var pred__46528 = cljs.core._EQ_;
var expr__46529 = mx;
if(cljs.core.truth_((pred__46528.cljs$core$IFn$_invoke$arity$2 ? pred__46528.cljs$core$IFn$_invoke$arity$2(mn,expr__46529) : pred__46528.call(null,mn,expr__46529)))){
return (0);
} else {
if(cljs.core.truth_((pred__46528.cljs$core$IFn$_invoke$arity$2 ? pred__46528.cljs$core$IFn$_invoke$arity$2(r,expr__46529) : pred__46528.call(null,r,expr__46529)))){
return ((60) * ((g - b) / d));
} else {
if(cljs.core.truth_((pred__46528.cljs$core$IFn$_invoke$arity$2 ? pred__46528.cljs$core$IFn$_invoke$arity$2(g,expr__46529) : pred__46528.call(null,g,expr__46529)))){
return (((60) * ((b - r) / d)) + (120));
} else {
if(cljs.core.truth_((pred__46528.cljs$core$IFn$_invoke$arity$2 ? pred__46528.cljs$core$IFn$_invoke$arity$2(b,expr__46529) : pred__46528.call(null,b,expr__46529)))){
return (((60) * ((r - g) / d)) + (240));
} else {
 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hsl__GT_rgb = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$hsl__GT_rgb(p__46548){
...
var color = map__46549__$1;
var hue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"hue","hue",-508078848));
var saturation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"saturation","saturation",-14247929));
var lightness = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46549__$1,new cljs.core.Keyword(null,"lightness","lightness",-2040901930));
...
var m1 = (((2) * l) - m2);
var vec__46555 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46540_SHARP_){
return Math.round((p1__46540_SHARP_ * (255)));
}),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__46558 = m1;
var G__46559 = m2;
var G__46560 = (h + (1.0 / (3)));
return (day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hue__GT_rgb.cljs$core$IFn$_invoke$arity$3 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hue__GT_rgb.cljs$core$IFn$_invoke$arity$3(G__46558,G__46559,G__46560) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hue__GT_rgb.call(null,G__46558,G__46559,G__46560));
})(),(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hue__GT_rgb.cljs$core$IFn$_invoke$arity$3 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hue__GT_rgb.cljs$core$IFn$_invoke$arity$3(m1,m2,h) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hue__GT_rgb.call(null,m1,m2,h)),(function (){var G__46562 = m1;
var G__46563 = m2;
var G__46564 = (h - (1.0 / (3)));
return (day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hue__GT_rgb.cljs$core$IFn$_invoke$arity$3 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hue__GT_rgb.cljs$core$IFn$_invoke$arity$3(G__46562,G__46563,G__46564) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hue__GT_rgb.call(null,G__46562,G__46563,G__46564));
})()], null));
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46555,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46555,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46555,(2),null);
return day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.rgb.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [r,g,b], null));
}
});
...
var G__46596 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(o,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([a__$1,b__$1], 0));
return (day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__46596) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.call(null,G__46596));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$make_color_operation_$_color_op__3 = (function() { 
var G__46890__delegate = function (a,b,more){
...
var G__46890 = function (a,b,var_args){
var more = null;
if (arguments.length > 2) {
var G__46896__i = 0, G__46896__a = new Array(arguments.length -  2);
while (G__46896__i < G__46896__a.length) {G__46896__a[G__46896__i] = arguments[G__46896__i + 2]; ++G__46896__i;}
  more = new cljs.core.IndexedSeq(G__46896__a,0,null);
} 
return G__46890__delegate.call(this,a,b,more);};
G__46890.cljs$lang$maxFixedArity = 2;
G__46890.cljs$lang$applyTo = (function (arglist__46897){
var a = cljs.core.first(arglist__46897);
arglist__46897 = cljs.core.next(arglist__46897);
var b = cljs.core.first(arglist__46897);
var more = cljs.core.rest(arglist__46897);
return G__46890__delegate(a,b,more);
});
...
var G__46905 = null;
if (arguments.length > 2) {
var G__46906__i = 0, G__46906__a = new Array(arguments.length -  2);
while (G__46906__i < G__46906__a.length) {G__46906__a[G__46906__i] = arguments[G__46906__i + 2]; ++G__46906__i;}
G__46905 = new cljs.core.IndexedSeq(G__46906__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$make_color_operation_$_color_op__3.cljs$core$IFn$_invoke$arity$variadic(a,b, G__46905);
}
...
return day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.update_hsla_field(color,new cljs.core.Keyword(null,"hue","hue",-508078848),cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__46611_SHARP_){
return cljs.core.mod(p1__46611_SHARP_,(360));
...
var G__46635 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(cljs.core._,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"red","red",-969428204),(255),new cljs.core.Keyword(null,"green","green",-945526839),(255),new cljs.core.Keyword(null,"blue","blue",-622100620),(255)], null),day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_rgb(color)], 0));
return (day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__46635) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.call(null,G__46635));
});
/**
...
var len__4736__auto___46916 = arguments.length;
var i__4737__auto___46917 = (0);
while(true){
if((i__4737__auto___46917 < len__4736__auto___46916)){
args_arr__4757__auto__.push((arguments[i__4737__auto___46917]));

var G__46919 = (i__4737__auto___46917 + (1));
i__4737__auto___46917 = G__46919;
continue;
} else {
}
break;
...
var G__46654 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.util.average,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c1,c2], 0));
return (day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.cljs$core$IFn$_invoke$arity$1(G__46654) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_color.call(null,G__46654));
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.mix.cljs$lang$applyTo = (function (seq46643){
var G__46644 = cljs.core.first(seq46643);
var seq46643__$1 = cljs.core.next(seq46643);
var G__46645 = cljs.core.first(seq46643__$1);
var seq46643__$2 = cljs.core.next(seq46643__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46644,G__46645,seq46643__$2);
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hue_rotations.cljs$lang$applyTo = (function (seq46658){
var G__46659 = cljs.core.first(seq46658);
var seq46658__$1 = cljs.core.next(seq46658);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46659,seq46658__$1);
}));
...
var iter__4529__auto__ = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$iter__46697(s__46698){
return (new cljs.core.LazySeq(null,(function (){
var s__46698__$1 = s__46698;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__46698__$1);
if(temp__5735__auto__){
var s__46698__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46698__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__46698__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__46700 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__46699 = (0);
while(true){
if((i__46699 < size__4528__auto__)){
var i = cljs.core._nth(c__4527__auto__,i__46699);
cljs.core.chunk_append(b__46700,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(c,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),(i * step)));

var G__46970 = (i__46699 + (1));
i__46699 = G__46970;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46700),day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$iter__46697(cljs.core.chunk_rest(s__46698__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46700),null);
}
} else {
var i = cljs.core.first(s__46698__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(c,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),(i * step)),day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$iter__46697(cljs.core.rest(s__46698__$2)));
}
} else {
return null;
}
...
return day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.update_hsla_field(color,new cljs.core.Keyword(null,"alpha","alpha",-1574982441),(function (p1__46747_SHARP_,p2__46748_SHARP_){
return day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.zero_to_one_clip((p1__46747_SHARP_ * ((1) + (p2__46748_SHARP_ / (100)))));
}),amount);
});
...
var vec__46762 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46758_SHARP_){
return (p1__46758_SHARP_ / (100));
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((100) - weight),weight], null));
var weight_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46762,(0),null);
var weight_2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46762,(1),null);
var vec__46765 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hex__GT_long,day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.as_hex),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [color_1,color_2], null));
var long_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46765,(0),null);
var long_2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46765,(1),null);
